...
class SubtractionLessonFragment : Fragment() {

    private var _binding: FragmentSubtractionLessonBinding? = null
    private val binding get() = _binding!!
    private val viewModel: SubtractionLessonViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSubtractionLessonBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.currentQuestion.observe(viewLifecycleOwner) { question ->
            ...
            binding.tvQuestion.text = getString(
                R.string.question_subtraction_format, question.operandA, question.operandB
            )
        ...
        viewModel.currentIndex.observe(viewLifecycleOwner) { index ->
            binding.tvProgress.text = getString(
                R.string.question_count_format, index + 1, SubtractionLessonViewModel.QUESTION_COUNT
            )
        }
